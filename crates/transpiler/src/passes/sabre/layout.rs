...
pub(crate)fn py_sabre_layout_and_routing(
    dag: &mut DAGCircuit,
    target: &PyTarget,
    heuristic: &Heuristic,
    ...
    sabre_layout_and_routing(dag, target.inner(), heuristic, max_iterations, num_swap_trials, num_random_trials, seed, partial_layouts, skip_routing)
}
