...
use qiskit_circuit::dag_circuit::{
    DAGCircuit, DAGCircuitBuilder, DAGCircuitInnerError, NodeType, Wire,
};
...
impl RoutingResult<'_> {
    ...
    pub fn rebuild(&self) -> Result<DAGCircuit, DAGCircuitInnerError> {
...
) -> Result<(DAGCircuit, NLayout), DAGCircuitInnerError> {
